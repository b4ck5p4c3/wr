...
- The footer carries a comments section. The comments are read by anyone through /api/v1/comments, and an owner of a site in the ring posts through /api/v1/comments/add. A comment may mention a site by its slug with an at sign, and the mention is linked to that site when the slug names a real one.
