...
- A carousel card carries an emoji reaction bar, the open-source Microsoft Fluent Emoji served as images from web/public/emoji. A signed-in visitor toggles a reaction through /api/sites/react, and the public listing carries the per-emoji counts.
