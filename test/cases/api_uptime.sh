...
sqlite3 "$DB" "INSERT INTO sites (slug,name,url,description,is_reachable,last_seen_at,owner_source,owner_name,created_at) VALUES ('up','Up','https://up.example','',1,9999999999,2,'toiletbril',7);"
