...
#define CONFIGURE_ARGS " '--with-ssl=openssl' '--without-icu' '--without-readline' '--without-zlib' '--without-libxml' 'CC=clang' 'CXX=clang++'"
...
#define PG_VERSION_STR "PostgreSQL 17.10 on x86_64-pc-linux-gnu, compiled by clang version 21.1.7, 64-bit"
